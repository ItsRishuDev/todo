...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		...
		var todos = [{id: 42, title: 'my todo', completed: false},
					{id: 43, title: 'my new todo', completed: false}];

		// sets up a todo-model			
		setUpModel(todos);

		// sets the called path 
		subject.setView('');
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
			// TODO: write test
			// check if view is called with filter => completed === false
		...
		it('should show completed entries', function () {
			// TODO: write test
			// check if view is called with filter => completed === true
	...
	it('should highlight "All" filter by default', function () {
		...
		expect(view.render).toHaveBeenCalledWith('setFilter', filterType);
	});
